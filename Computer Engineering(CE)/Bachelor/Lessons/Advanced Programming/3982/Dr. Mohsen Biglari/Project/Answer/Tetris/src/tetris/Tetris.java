...
public class Tetris extends JPanel implements Runnable {
    ...
    void selectShape() {
	    ...
	    Level = new JLabel("Level: " + scoreboard.getTopscore());
	        Level.setBounds(460,   330, 100, 30);
	    Score = new JLabel("Score: " + scoreboard.getScore());
	      Score.setBounds(460,   370, 100, 30);
	    add(Level);
	    add(Score);
    ...
    void drawStartScreen(Graphics2D g) {
        ...
        g.setFont(smallFont);
        g.drawString("Start", clickX, clickY);
    }
...
final class Config {
    final static Color[] colors = {Color.green, Color.red, Color.blue,
            Color.pink, Color.orange, Color.cyan, Color.magenta,Color.darkGray,Color.yellow};

    final static Font mainFont = new Font("Tahoma", Font.BOLD, 48);
    ...
    final static Stroke largeStroke = new BasicStroke(2);
    final static Stroke smallStroke = new BasicStroke(1);

    final static Color squareBorder = Color.black;
    final static Color titlebgColor = Color.YELLOW;
    final static Color textColor = Color.orange;
    final static Color bgColor = new Color(0x636363, false);
    final static Color gridColor = new Color(0xFFFFFF);
    final static Color gridBorderColor = new Color(0x000000);
}
