...
;http://www.hpinfotech.com
;
;Project : Counter from 155 to 255
;Version : 1
;Date    : 12/17/2021
;Author  : MosFazli
;Company : Knights
...
; 0000 004B OCR2=0x00;
	OUT  0x23,R30
; 0000 004C 
; 0000 004D TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 004E 
...
; 0000 0068       j = 155;
	...
	MOVW R6,R30
; 0000 0069       }
; 0000 006A       sprintf(str,"value=%d",j);
_0x7:
	LDI  R30,LOW(_str)
	LDI  R31,HIGH(_str)
	ST   -Y,R31
